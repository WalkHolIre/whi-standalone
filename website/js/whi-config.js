...
window.WHI_CONFIG = {
  ...
  TOUR_SLUGS: {
    'dingle-way':           { page: 'tours/dingle-way.html',           dest: 'walking-area-dingle.html' },
    'kerry-way':            { page: 'tours/kerry-way.html',            dest: 'walking-area-kerry.html' },
    'wicklow-way':          { page: 'tours/wicklow-way.html',          dest: 'walking-area-wicklow.html' },
    'wicklow-way-5-days':   { page: 'tours/wicklow-way-5-days.html',   dest: 'walking-area-wicklow.html' },
    'wicklow-way-7-days':   { page: 'tours/wicklow-way-7-days.html',   dest: 'walking-area-wicklow.html' },
    'wicklow-way-10-days':  { page: 'tours/wicklow-way-10-days.html',  dest: 'walking-area-wicklow.html' },
    'barrow-way':           { page: 'tours/barrow-way.html',           dest: 'walking-area-barrow.html' },
    'barrow-way-5-days':    { page: 'tours/barrow-way-5-days.html',    dest: 'walking-area-barrow.html' },
    'burren-way':           { page: 'tours/burren-way.html',           dest: 'walking-area-burren.html' },
    'burren-5-days':        { page: 'tours/burren-5-days.html',        dest: 'walking-area-burren.html' },
    'burren-6-days':        { page: 'tours/burren-6-days.html',        dest: 'walking-area-burren.html' },
    'burren-7-days':        { page: 'tours/burren-7-days.html',        dest: 'walking-area-burren.html' },
    'causeway-coast':       { page: 'tours/causeway-coast.html',       dest: 'walking-area-causeway.html' },
    'causeway-coast-5-days':{ page: 'tours/causeway-coast-5-days.html',dest: 'walking-area-causeway.html' },
    'cooley-mournes':       { page: 'tours/cooley-mournes.html',       dest: 'walking-area-cooley.html' },
    'cooley-peninsula-5-days':{ page: 'tours/cooley-peninsula-5-days.html', dest: 'walking-area-cooley.html' },
  },
